...
import { AdminAuditsChart } from './AdminAuditsChart'
import { getAudits, getClients } from '@/lib/data'
...
export default async function AdminDashboard({ session }) {
	const { auditCount, clientCount, completedAudits, recentAudits } = await getDashboardData(session)
